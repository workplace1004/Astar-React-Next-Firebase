  ...
  return (
    <>
      ...
      >
        ...
        <div className="hidden lg:flex items-center gap-14 text-sm tracking-wide">
          {navLinks.map((link) =>
            link.hash ? (
              <a
        ...
        <div className="flex items-center gap-3">
          ...
          >
            {isAuthenticated ? "Mi portal" : "Crear cuenta gratis"}
          </button>
          <button type="button" onClick={() => setMenuOpen(!menuOpen)} className="lg:hidden p-2 text-muted-foreground hover:text-foreground">
        ...
        >
          <div className="flex flex-col gap-4">
            ...
            <button
              ...
              className="text-sm px-5 py-2.5 rounded-full shimmer-gold text-primary-foreground font-medium tracking-wide mt-2"
            >
              {isAuthenticated ? "Mi portal" : "Crear cuenta gratis"}
            </button>
          </div>
